...
4) Карточка отметки выполнения (Entry)
...
5) Карточка напоминания (Reminder)
...
6) Карточка статистики/streak (вычисляемая или отдельная сущность)
...
7) Карточка категории (опционально)
