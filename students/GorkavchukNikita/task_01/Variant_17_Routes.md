...
3. Просмотр «Мои заказы» (для залогиненного пользователя)
...
4. Админ-панель: подготовка справочников адресов
...
5. Админ-панель: создание и управление заказами
...
6. Админ-панель: события трекинга (таймлайн)
...
7. Бонусы (опционально)

- Webhooks: отправка внешних уведомлений при появлении новых events
- Карта: отображение движения по узлам (Location) при наличии координат (можно расширить Location)
- Документация API + тесты + CI/CD + Kubernetes
