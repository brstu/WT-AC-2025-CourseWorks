      ...
      <Layout>
        <PageTransition>
          <Routes>
            ...
            <Route path="/deals" element={<RequireAuth><DealsList /></RequireAuth>} />
            <Route path="/deals/new" element={<RequireAuth><DealForm /></RequireAuth>} />
            <Route path="/deals/:id" element={<RequireAuth><DealForm /></RequireAuth>} />
            <Route path="/stages" element={<RequireAuth><StagesList /></RequireAuth>} />
            <Route path="/tasks" element={<RequireAuth><TasksList /></RequireAuth>} />
            <Route path="/tasks/new" element={<RequireAuth><TaskForm /></RequireAuth>} />
            <Route path="/tasks/:id" element={<RequireAuth><TaskForm /></RequireAuth>} />
            ...
            <Route path="/invoices/:id" element={<RequireAuth><InvoiceForm /></RequireAuth>} />
